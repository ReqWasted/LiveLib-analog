namespace LiveLib.Application.Commom.ResultWrapper
{
    ...
    public record Error(ErrorCode Code, string Message)
    {
        ...
        public static Error Validation(string? message) => new(ErrorCode.BadRequest, message ?? "Validation error");
    ...
    public class Result
    {
        ...
        public static Result Success() => new(true, successStatus: ResultWrapper.Success.Ok(null));

        public static Result Ok(string? message = null) => new(true, successStatus: ResultWrapper.Success.Ok(message));
        public static Result Created(string? message = null) => new(true, successStatus: ResultWrapper.Success.Created(message));
        public static Result Accepted(string? message = null) => new(true, successStatus: ResultWrapper.Success.Accepted(message));
        public static Result NoContent(string? message = null) => new(true, successStatus: ResultWrapper.Success.NoContent(message));
        public static Result<T> Success<T>(T value, Success? success = null) => Result<T>.Success(value, success ?? ResultWrapper.Success.Ok(null));
    ...
    public class Result<T> : Result
    {
        ...
        public static Result<T> Success(T value) => new(value, true, successStatus: ResultWrapper.Success.Ok(null));

        public static new Result<T> Ok(string? message = null) => new(default, true, successStatus: ResultWrapper.Success.Ok(message));
        public static new Result<T> Created(string? message = null) => new(default, true, successStatus: ResultWrapper.Success.Created(message));
        public static new Result<T> Accepted(string? message = null) => new(default, true, successStatus: ResultWrapper.Success.Accepted(message));
        public static new Result<T> NoContent(string? message = null) => new(default, true, successStatus: ResultWrapper.Success.NoContent(message));
